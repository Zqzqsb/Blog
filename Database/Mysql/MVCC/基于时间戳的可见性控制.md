...
![1. 时间戳从哪里来：授时服务](./基于时间戳的可见性控制.assets/1.-时间戳从哪里来：授时服务.svg)
...
![2. 两个核心时间戳：txnstartts 与 readstartts](./基于时间戳的可见性控制.assets/2.-两个核心时间戳：txnstartts-与-readstartts.svg)
...
![3. 版本存储：RocksDB 的 KV 编码](./基于时间戳的可见性控制.assets/3.-版本存储：RocksDB-的-KV-编码.svg)
...
![4.1 InnoDB：活跃列表过滤](./基于时间戳的可见性控制.assets/4.1-InnoDB：活跃列表过滤.svg)
...
![4.2 RocksDB / TiKV：committs 直接比较](./基于时间戳的可见性控制.assets/4.2-RocksDB-TiKV：committs-直接比较.svg)
